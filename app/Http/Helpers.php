...
if (!function_exists('product_image_upload')) {
    function product_image_upload($image_info)
    {
        ...
        if ($image_info) {
            ...
            $upload = new Upload;
            $extension = strtolower($image_info->getClientOriginalExtension());
            ...
            if (isset($type[$extension])) {
                ...
                $arr = explode('.', $image_info->getClientOriginalName());
                ...
                $path = $image_info->store('uploads/all', 'local');
                ...
                if ($type[$extension] == 'image' && get_setting('disable_image_optimization') != 1) {
                    try {
                        $img = Image::make($image_info->getRealPath())->encode();
                        $height = $img->height();
                        $width = $img->width();
