...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        if ($request->hasFile('product_image')) {
            ...
            $upload_image = product_image_upload($request->file('product_image'));
            if($upload_image){
              $product->photos = $upload_image->id;
              $product->thumbnail_img = $upload_image->id;
              $product->save();
            }
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        if ($request->hasFile('product_image')) {
          ...
          $edit_image = Upload::findOrFail($product->photos);
           if ($edit_image->file_name && file_exists(public_path($edit_image->file_name))) {
               unlink(public_path($edit_image->file_name));
               $delete_img = Upload::where('id', $edit_image->id)->first();
