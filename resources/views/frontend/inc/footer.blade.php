...
<section class="py-lg-3 text-light footer-widget" style="background-color: #194a22 !important;">
    ...
    <div class="container d-none d-lg-block">
        <div class="row">
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <div class="mt-3 mb-4">
                        <a href="{{ route('home') }}" class="d-block">
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" style="height: 38px;">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    <h4 class="fs-14 text-uppercase fw-700 mb-3">{{ translate('Contacts') }}</h4>
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    <h4 class="fs-14 text-uppercase fw-700 mb-3">{{ translate('My Account') }}</h4>
                    <ul class="list-unstyled">
                        @if (Auth::check())
                        <li class="mb-2">
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 text-light" style="background-color: #1e4525; border-top: 0.01px solid grey;">
    <div class="container">
