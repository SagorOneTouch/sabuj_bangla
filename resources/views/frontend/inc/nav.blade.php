    ...
    <header class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                        <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @if ($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                class="mw-100" height="25" style="width: auto; height: 40px;">
                            @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}"
                                class="mw-100" height="25">
                            @endif
                        </a>
                    </div>
        ...
        <!-- Menu Bar -->
        <div class="d-none d-lg-block position-relative h-50px" style="background-color: #389d44;">
