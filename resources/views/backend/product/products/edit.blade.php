                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="file" id="productImage" name="product_image">
                                  <input class="form-control" type="hidden" id="productImage" name="photos" value="{{ $product->photos }}">
                            </div>
                        </div>
                      
                       <div class="form-group row">
                         <label class="col-lg-3 col-from-label">{{translate('Old Images')}}</label>
                        <div class="col-lg-8">
                            <div id="photos">
                              
                                <div class="col-md-4 col-sm-4 col-xs-6">
                                    <div class="img-upload-preview">
                                        <img loading="lazy"  src="{{ uploaded_asset($product->photos) }}" alt="" class="img-responsive" style="height: 100px; width: auto;">
